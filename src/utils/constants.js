export const projectInfo = [
    {
        ...
        pictures:
            [
                { picture: 'http://localhost:8000/pics/Projects/LittleCrushingCars/LittleCrushingCars.png' }
            ],
        deployed_link:
    ...
    },
    {
        ...
        pictures: [{ picture: 'http://localhost:8000/pics/Projects/TechLodge/TechLodge.png' }],
        clients: [
            {
    ...
    },
    {
        ...
        pictures: [{ picture: 'http://localhost:8000/pics/Projects/BestShop/BestShop.png' }],
        tech_lang: [
            {
                name: 'HTML',
                description:
    ...
    },
    {
        ...
        pictures:
            [{ picture: 'http://localhost:8000/pics/Projects/CellularAutomata/CellularAutomata.png' }],
    ...
    },
    {
        ...
        pictures: [{ picture: 'http://localhost:8000/pics/Projects/ClandesThirst/ClandesThirst.png' }],
